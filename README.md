...
Grabs the latest image from the clipboard (any snip from the screen), transforms it to text, and places the text inside the clipboard ready to be pasted, in milliseconds.
