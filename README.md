...
Extract any image to text, from anywhere in seconds. | Integrating Tesseract OCR via a shortcut on Windows.

I called this automation Snippet2Text, as it works by grabbing the last image from the clipboard, turning it to text, and pasting it back on the clipboard for instant image-to-text transcription.
